...
function init() {
  ...
  player.cursor.y = canvas.height/2;
...
map.draw = function(ctx, camX, camY) {
  var i = 0;
  for (var y = 0; y < 520; y += 60) {
    for (var x = 0; x < 660; x += 60) {

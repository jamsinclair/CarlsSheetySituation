...
Game.draw = function (ctx) {
  ...
  ctx.fillStyle = '#000';
  ctx.font = '20px Arial';
  ctx.fillText(this.camera.xView + " " + this.camera.yView,500,30);
  ctx.fillText(Math.round(this.camera.xView+this.player.cursor.x) + " " + Math.round(this.camera.yView+this.player.cursor.y),500,60);
};
